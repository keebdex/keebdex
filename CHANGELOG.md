...
- Added a **Colorway Submissions** dashboard at `/artisan/colorway-submissions`: Admins, Editors, and Makers can **approve**, **reject**, or **edit & approve** pending submissions, while regular users can view, edit, and delete their own submission until it's reviewed, or delete it after it's rejected.
